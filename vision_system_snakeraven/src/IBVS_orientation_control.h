...
public:
	...
	Matrix<double, 2 * Max_features, 1> Error;
	int curr_features;
	...
	//Compute Control Law:
	void Compute_Control_law(std::vector<double> posU, std::vector<double> posV, std::vector<double> deltaU, std::vector<double> deltaV);
